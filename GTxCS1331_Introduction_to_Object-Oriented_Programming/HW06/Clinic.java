...
public class Clinic {
	...
	public static void main (String[] args) throws IOException {
		...
		while ((line = br.readLine()) != null) { //returns a Boolean value  
			...
			if (appointment[1].equals("Dog") == false && appointment[1].equals("Cat") == false) {
			...
			if (appointment[1].equals("Dog")) {
                Dog dog = new Dog(appointment[0], health, painLevel, Double.parseDouble(appointment[2]));
